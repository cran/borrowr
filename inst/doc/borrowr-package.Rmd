...
- `data`: a data frame from which the PATE is estimated. It must include all the variables in the formula, and it must also include a character variable indicating the data sources.
